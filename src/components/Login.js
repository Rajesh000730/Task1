...
function Login() {
    return (
        <div className="w-full h-full bg-neutral-50 flex flex-col items-center justify-evenly bg-slate-700">
            <div className="w-[500px] h-[500px]  shadow-2xl  flex flex-col items-center justify-evenly bg-slate-50">
